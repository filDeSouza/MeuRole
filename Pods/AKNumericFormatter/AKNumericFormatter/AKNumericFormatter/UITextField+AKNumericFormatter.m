...
static char UITextFieldTendCaretToRight;
...
{
  objc_setAssociatedObject(self, &UITextFieldTendCaretToRight, @(handleDeleteBackwards), OBJC_ASSOCIATION_COPY);
}

-(BOOL)handleDeleteBackwards
{
  return [objc_getAssociatedObject(self, &UITextFieldTendCaretToRight) boolValue];
}
